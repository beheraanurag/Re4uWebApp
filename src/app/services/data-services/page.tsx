...
export const metadata: Metadata = {
  ...
  description:
    "Data analysis and statistics support services with research design and methodology support for sampling logic, instruments, and analysis pathways.",
};
      ...
      <div className="mx-auto max-w-[1240px] px-4 sm:px-[18px]">
        <div className="mb-6 sm:mb-8">
          ...
          <p className="max-w-3xl text-sm text-[var(--muted-service)] sm:text-lg">
            Research design & methodology support for sampling logic,
            instruments/tools, and analysis pathways that fit your research
            questions and ethics requirements.
          </p>
        </div>
        <Card className="rounded-[18px] border border-[var(--line)] bg-[rgba(255,255,255,.72)] p-5 shadow-[0_10px_24px_rgba(20,35,45,.10)] sm:rounded-[22px] sm:p-8">
          ...
          <ul className="mb-4 space-y-2 text-sm text-[var(--muted-service)] sm:mb-6 sm:space-y-3 sm:text-base">
            ...
            <li>• Sampling logic guidance</li>
            <li>• Research instrument development</li>
          </ul>
          <Button
            asChild
